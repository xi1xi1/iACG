    ...
    return Material(
      ...
      child: Column(
        children: [
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: unreadCount > 0 ? Colors.black : const Color(0xFF333333),
                                ),
                                maxLines: 1,
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 14,
                            color: unreadCount > 0 ? const Color(0xFF333333) : const Color(0xFF666666),
          ...
          // 直接在底部添加分割线
          Container(
            margin: const EdgeInsets.only(left: 72), // 从头像右边开始
            height: 0.5,
            color: const Color(0xFFEEEEEE), // 淡淡的灰色
          ),
        ],
      ),
    );
