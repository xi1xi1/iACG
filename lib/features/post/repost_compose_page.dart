  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('转发'),
        actions: [
          // 修改：右上角仅保留“发布”按钮（样式优化为微博橙色）
          Container(
            padding: const EdgeInsets.only(right: 20.0, top: 11.0, bottom: 11.0),
            child: TextButton(
              style: TextButton.styleFrom(
                backgroundColor: const Color(0xFFED7099), // 微博橙色
                disabledBackgroundColor: const Color(0xFFED7099).withOpacity(0.5),
              ...
              child: Row(
                children: [
                  Checkbox(
                    ...
                    onChanged: (value) {
                      setState(() => _isCommentEnabled = value ?? true);
                    },
                    activeColor: const Color(0xFFED7099),
                  ),
                  const Text('同时评论', style: TextStyle(fontSize: 14)),
                ],
              ),
            ),
