...
class SearchCosTab extends StatefulWidget {
...
class _SearchCosTabState extends State<SearchCosTab> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> _loadMore() async {
    ...
    try {
      final result = await widget.searchService.searchCosPosts(
  ...
  @override
  void didUpdateWidget(SearchCosTab oldWidget) {
